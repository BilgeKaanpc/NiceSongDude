...
adapter adapter;
    ...
    public void getData(){
        ...
        dataReferance.whereEqualTo("mail",userMail).addSnapshotListener(new EventListener<QuerySnapshot>() {
            ...
            public void onEvent(@Nullable QuerySnapshot value, @Nullable FirebaseFirestoreException error) {
                if(error != null){
                    Toast.makeText(music.this,error.getLocalizedMessage().toString(),Toast.LENGTH_SHORT).show();
                }
                if(value != null){
    ...
    public void search(){
        ...
        CollectionReference dataReferance = db.collection("user");
        dataReferance.whereEqualTo("Music",musicWhat).addSnapshotListener(new EventListener<QuerySnapshot>() {
            @Override
            public void onEvent(@Nullable QuerySnapshot value, @Nullable FirebaseFirestoreException error) {
                if(error != null){
                    Toast.makeText(music.this,error.getLocalizedMessage().toString(),Toast.LENGTH_SHORT).show();
