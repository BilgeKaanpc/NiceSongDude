...
public class city extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RecyclerView rv = findViewById(R.id.listRec);
    ...
    public void getData(){
        ...
        dataReferance.whereEqualTo("mail",userMail).addSnapshotListener(new EventListener<QuerySnapshot>() {
            ...
            public void onEvent(@Nullable QuerySnapshot value, @Nullable FirebaseFirestoreException error) {
                if(error != null){
                    Toast.makeText(city.this,error.getLocalizedMessage().toString(),Toast.LENGTH_SHORT).show();
                }
                if(value != null){
    ...
    public void search(){
        ...
        CollectionReference dataReferance = db.collection("user");
        dataReferance.whereEqualTo("City",cityWhat).addSnapshotListener(new EventListener<QuerySnapshot>() {
            @Override
            public void onEvent(@Nullable QuerySnapshot value, @Nullable FirebaseFirestoreException error) {
                if(error != null){
                    Toast.makeText(city.this,error.getLocalizedMessage().toString(),Toast.LENGTH_SHORT).show();
